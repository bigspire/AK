	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Add Personality Profiling</span> </div>
		...
		<div class="form-group">
				...
				<select  class="form-control">
				 ...
				 <div class="form-group">
                  ...
                  <textarea id="name" name="name" type="text" class="form-control error" required=""></textarea>
				  	<select  class="form-control">
				  <option>Select</option>
				  <option>Tamil</option>
				...
				<div class="row form-group">
                  				<label for="name" class="col-md-1">Option 1 </label>
									...
									<div class="col-xs-1"><input id="name0" name="name0" type="text" class="form-control error" placeholder="Score" required="" idtemplate="name%23index%23" nametemplate="name%23index%23"></div>
...
<div class="col-xs-1"><input id="name0" name="name0" type="text" class="form-control error" placeholder="Score" required="" idtemplate="name%23index%23" nametemplate="name%23index%23"></div>								
		...
		<div class="row form-group">
                ...
                <div class="form-group">
				 ...
				 <a href="pp.php"><input type="button" value="Cancel" class="btn btn-default pull-left"></a>
