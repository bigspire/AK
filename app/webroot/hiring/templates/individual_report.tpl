	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Individual Report </span> </div>
              ...
              <form class="cmxform" id="altForm" method="post" novalidate="novalidate">
               <div class="form-group">
                ...
                <div class="form-group">
	             ...
	             {/if}
				  	<div class="pr20  pull-left"><input class="submit btn bg-green2" type="download" value="Download PDF"></div>
