        ...
        <div class="col-sm-3">
          <div class="panel panel-overflow mb10">
            <div class="panel-body pn pl20">
              ...
              <h2 class="mt15 lh15 text-grey2"><b>18</b></h2>
              <h5 class="text-muted">Companies in <span style="color:#777;font-size:12px;">Total</span></h5>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="panel panel-overflow mb10">
            <div class="panel-body pn pl20">
              ...
              <h2 class="mt15 lh15 text-teal2"><b>12090</b></h2>
              <h5 class="text-muted">Drives  in <span style="color:#777;font-size:12px;">Total</span></h5>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="panel panel-overflow mb10">
            <div class="panel-body pn pl20">
              ...
              <h2 class="mt15 lh15 text-blue2"><b>1900</b></h2>
              <h5 class="text-muted">Candidates in <span style="color:#777;font-size:12px;">Total</span></h5>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="panel panel-overflow mb10">
            <div class="panel-body pn pl20">
              ...
              <h5 class="text-muted">Questionaire in <span style="color:#777;font-size:12px;">Total</span></h5>
            </div>
          </div>
        </div>
      </div>
          ...
          <!--  <div class="panel-heading"> <span class="panel-title"><i class="fa fa-pencil"></i> Live Hiring Activity </span>
        ...
        <div class="col-md-6">
           <div class="panel">
            <div class="panel-heading"> <span class="panel-title">
             <span class="glyphicon glyphicon-stats"></span> Companies </span> </div>
            <div class="panel-menu">
              <div id="adcompanieschoices"></div>
            </div>
            <div class="panel-body">
              <div class="adcompanies-toggle" style="height: 300px; width: 100%;"></div>
            </div>
          </div>
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title">
             <span class="glyphicon glyphicon-stats"></span>Drives </span> </div>
            <div class="panel-menu">
              <div id="adaccessedchoices"></div>
            </div>
            <div class="panel-body">
              <div class="adaccessed-toggle" style="height: 300px; width: 100%;"></div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
           <div class="panel">
            <div class="panel-heading"> <span class="panel-title">
             <span class="glyphicon glyphicon-stats"></span> Candidates </span> </div>
            <div class="panel-menu">
              <div id="adquestionschoices"></div>
            </div>
            <div class="panel-body">
              <div class="adquestions-toggle" style="height: 300px; width: 100%;"></div>
            </div>
          </div>
        <div class="panel">
            <div class="panel-heading"> <span class="panel-title">
             <span class="glyphicon glyphicon-stats"></span> Questionaire </span> </div>
            
            <div class="panel-body" style="height: 388px; ">
                  <div class="addriveschart-pie" style="height: 360px; width: 100%;"></div>
                </div>
         <!--   <div class="panel-body">
              <div class="addrives-toggle" style="height: 300px; width: 100%;"></div>
            </div>-->
          </div>
                ...
                <div id="tab1" class="tab-pane active p15">
                  <div class="row">
                    <div class="col-lg-12 pn">
                      <div id="graph" style="height: 345px; width: 100%;"></div>
                    </div>
              ...
              <div class="row">
                <div class="col-lg-3 visible-lg mt5">
                  <div class="text-block text-center">
                    <h5 class="mbn text-muted">This year total hired</h5>
                    <h4 class="mb5"><b>1458 </b></h4>
                  </div>
                </div>
                <div class="col-md-12 col-lg-9 mt5 pr25">
                  <div class="row">
                    <div class="col-xs-6 col-sm-3 text-center">
                      <div class="media">
                        <div class="media-object pull-left pt10 mrn"><span class="stateface  fs26 text-purple"></span></div>
                        <div class="media-body">
                          <h6 class="media-heading mbn">This month total hired </h6>
                          <h5 class="mb5">394</h5>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                      <div class="media">
                        <div class="media-object pull-left pt10 mrn"><span class="stateface  fs24 text-orange"></span></div>
                        <div class="media-body">
                          <h6 class="media-heading mbn">This week total hired </h6>
                          <h5 class="mb5">34</h5>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                      <div class="media">
                        <div class="media-object pull-left pt10 mrn"><span class="stateface  fs22 text-teal"></span></div>
                        <div class="media-body">
                          <h6 class="media-heading mbn">In last 6 months hired </h6>
                          <h5 class="mb5">127</h5>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center prn">
                      <div class="media">
                        <div class="media-object pull-left pt10 mrn"><span class="stateface  fs24 text-green2"></span></div>
                        <div class="media-body">
                          <h6 class="media-heading mbn">Total candidates so far </h6>
                          <h5 class="mb5">1500</h5>
                        </div>
                      </div>
                    </div>
                  </div>
...
if ($(".accessed-toggle").length) {
			...
			// countries are turned on/off
				//alert (JSON.stringify(datasets[0].term));   
			var i = 0;
			$.each(datasets4, function(key, val) {
				//alert (JSON.stringify(val));  
				val.color = i;
				++i;
			});
			...
			// insert checkboxes 
			var choiceContainer4 = $("#accessedchoices");
			var i2 = 0;
			$.each(datasets4, function(key, val){
				if(key == 'Monthly'){
					choiceContainer4.append("<div class='radioinline'><input type='radio' name='accessedchoices' checked='checked' id='" + key + "'/> <label for='" + key + "'>" + val.label + "</label></div>");
				}else{
					choiceContainer4.append("<div class='radioinline'><input type='radio' name='accessedchoices' id='" + key + "'/> <label for='" + key + "'>" + val.label + "</label></div>");	
				}
			});
			
			choiceContainer4.find("input").click(function() {
				plotAccordingToChoices4();
			});
			
			var plotAccordingToChoices4 = function() {
				var data = [];
				choiceContainer4.find("input:checked").each(function () {
					var key = $(this).attr("id");
					if (key && datasets4[key]) {
						data.push(datasets4[key]);
					}
				});
...
if ($(".adcompanies-toggle").length) {
			...
			var datasets2 = {
				...
				"comWeekly": {
					label: "Weekly",
					data: [[61, 45], [62, 12], [63, 45], [64, 47], [65, 12], [66, 28]]
				},         
				"comMonthly": {
					label: "Monthly",
			...
			// insert checkboxes 
			var choiceContainer2 = $("#adcompanieschoices");
			var i2 = 0;
			$.each(datasets2, function(key, val){
				if(key == 'comWeekly'){
					choiceContainer2.append("<div class=' radioinline'><input type='radio' name='companieschoices' checked='checked' class='cursor' id='" + key + "'/> <label class='cursor' for='" + key + "'>" + val.label + "</label></div>");
				}else{
					choiceContainer2.append("<div class=' radioinline'><input type='radio' name='companieschoices' class='cursor' id='" + key + "'/> <label class='cursor' for='" + key + "'>" + val.label + "</label></div>");	
				}			
			});
			...
			var plotAccordingToChoices2 = function() {
				var data = [];
				...
				if (data.length > 0) {
					$.plot(".adcompanies-toggle", data, {
						...
						xaxis: {
							...
							[12, 12],[13,13],[14,14],[15, 15],[16, 16],[17, 17],[18,18],[19,19],[20,10],
							[22, 22],[23,23],[24,24],[25, 25],[26, 26],[27, 27],[28,28],[29,29],[30,30],[31,31],
							[40,'Jan'],[41,'Feb'],[42,'Mar'],[43,'Apr'],[44,'May'],[45,'Jun'],[46,'Jul'],[47,'Aug']
							,[48,'Sep'],[49,'Oct'],[50,'Nov'],[51,'Dec'],
							[60,'4-Dec'],[61,'11-Dec'],[62,'18-Dec'],[63,'25-Dec'],[64,'1-Jan'],[65,'8-Jan'],
...
if ($(".adaccessed-toggle").length) {
			...
			$.each(datasets, function(key, val){
				if(key == 'accWeekly'){
					choiceContainer.append("<div class='radioinline'><input class='cursor' type='radio' name='accessedchoices' checked='checked' id='" + key + "'/> <label class='cursor' for='" + key + "'>" + val.label + "</label></div>");
				}else{
					choiceContainer.append("<div class='radioinline'><input class='cursor' type='radio' name='accessedchoices' id='" + key + "'/> <label class='cursor' for='" + key + "'>" + val.label + "</label></div>");	
				}
			});
...
if ($(".adquestions-toggle").length) {
			...
			// insert checkboxes 
			var choiceContainer3 = $("#adquestionschoices");
			var i2 = 0;
			$.each(datasets3, function(key, val){
				if(key == 'queWeekly'){
					choiceContainer3.append("<div class='radioinline'><input type='radio' class='cursor' name='questionschoices' checked='checked' id='" + key + "'/> <label class='cursor' for='" + key + "'>" + val.label + "</label></div>");
				}else{
					choiceContainer3.append("<div class='radioinline'><input type='radio' class='cursor' name='questionschoices' id='" + key + "'/> <label class='cursor' for='" + key + "'>" + val.label + "</label></div>");	
				}
			});
			
			choiceContainer3.find("input").click(function() {
				plotAccordingToChoices3();
			});
			
			var plotAccordingToChoices3 = function() {
				var data = [];
				choiceContainer3.find("input:checked").each(function () {
					var key = $(this).attr("id");
