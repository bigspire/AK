	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Companies >> Add Company User </span> </div>
            ...
            {if $EXIST_MSG}
               <div class="alert alert-danger alert-dismissable">
			  	...
			  	{/if}			  
              <form action="add_company_user.php?company_id={$smarty.get.company_id}" class="cmxform" id="altForm" method="post" novalidate="novalidate">
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <input  name="password" value="{$password}" type="password" class="form-control error" required="">
              <label for="name" class="error">{$passwordErr}</label>
                </div>
                <div class="form-group">
                  <label for="name">Confirm Password <span class="mandate">*</span></label>
                  <input name="confirm_password" value="{$confirm_password}" type="password" class="form-control error" required="">
                ...
                <div class="form-group">
			  			<input type="button" value="Cancel" class="btn btn-default pull-left"  onclick="window.location='company.php'">
