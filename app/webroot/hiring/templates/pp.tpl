	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Personality Profilling Test </span> </div>
			...
			<input class="submit btn  btn-xs bg-orange2" style="color:#fff;width:auto;" type="submit" value="Go">
                  ...
                  <tbody>
                    <tr>
					 <td><a href="view_pp.php">Discipline</a></td>
					 	<td>25</td>
