	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Add Competency </span> </div>
            <div class="panel-body">
              ...
              <form class="cmxform" id="altForm" method="post" novalidate="novalidate">
                <div class="form-group">
                  ...
                  <input id="name" name="name" type="text" class="form-control error" required=""><label for="name" class="error">This field is required.</label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
			<input type="button" value="Cancel" class="btn btn-default pull-left"  onclick="window.location='competency.php'">
