	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Situational Response Test </span> </div>
            <div class="panel-body">
              <div class="table-responsive">
                <!-- div class="alert alert-success alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <strong>Well done!</strong> You successfully created the company </div-->
						
				<!--		<div class="pull-right mb10">
						<a href="add_candidate.php"><button type="button" class="btn bg-orange2"><i class="fa fa-home"></i> Add Candidate</button></a>
						</div>-->
			...
			<input class="submit btn  btn-xs bg-orange2" style="color:#fff;width:auto;" type="submit" value="Go">
                  ...
                  <thead>
                    <tr>
					<th class="sorting" tabindex="0" 	title="Situation: activate to sort column ascending" style="width: 250px;">Situation</th>                     
                   <th class="sorting" tabindex="0" 	title="No. of Questions: activate to sort column ascending" style="width: 100px;">Questions</th>                     
				   	<th class="sorting" tabindex="0" 	title="Company Name: activate to sort column ascending" style="width: 150px;">Company</th>

					<th class="sorting" tabindex="0" 	title="Competency Name: activate to sort column ascending" style="width:150px;">Competency</th>
					<th class="sorting" tabindex="0" 	title="Status: activate to sort column ascending" style="width: 100px;">Status</th>
					<th class="sorting_desc" tabindex="0" 	title="Created: activate to sort column ascending" style="width: 100px;">Created</th>
					<th width="50">Options</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
					 <td><a href="view_pp.php">You are the Manager in-charge for ABC airlines operation in 
					 Goa airport. ABC is known for its low cost operations. Today is 27th of Dec, 
					 the Sunday and the time now is 9pm...</a></td>
					 	<td>25</td>
						<td>Hero Honda</td>
                      <td>Discipline, Stress Management</td>
