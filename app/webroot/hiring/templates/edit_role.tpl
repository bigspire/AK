	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Edit Role </span> </div>
            <div class="panel-body">
               ...
               <div class="alert alert-danger alert-dismissable">
			  	...
			  	{/if}
              <form action="edit_role.php?id={$getid}" class="cmxform" id="altForm" method="post" novalidate="novalidate">
                ...
                <div class="form-group">
                  ...
                  <select  name="modules_id[]" style="width:97%" multiple="multiple" size="10" separator="  " class="multi_select form-control" id="RolePermission">
				  			{html_options options=$permissions selected=$modules_id}		 
						</select>
 						<label for="name" class="error">{$permissionErr}</label>
                </div>
				<div class="form-group">
                  <label> Description </label>
                  <textarea id="description" name="description" class="form-control">{if $role_desc}{$role_desc}{else}{$smarty.post.description}{/if}</textarea>
                </div>
