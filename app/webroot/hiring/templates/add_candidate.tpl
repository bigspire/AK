	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Add Candidate </span> </div>
            <div class="panel-body">
               ...
               <div class="alert alert-danger alert-dismissable">
			  	...
			  	{/if}
              <form action="add_candidate.php" class="cmxform" id="altForm" method="post" novalidate="novalidate">
			  ...
			  <label for="name" class="error">{$last_nameErr}</label>
                  ...
                  <input id="email" name="emp_id" value="{$smarty.post.emp_id}" type="text" class="form-control error" required="">
                <label for="name" class="error">{$emp_idErr}</label>
                </div>
                <div class="form-group">
                  <label for="name">Department </label>
                  <input name="department" value="{$smarty.post.department}" type="text" class="form-control error" required="">
                <label for="name" class="error">{$emp_idErr}</label>
                </div>
                <div class="form-group">
                  <label for="name">Designation </label>
                  <input name="designation" value="{$smarty.post.designation}" type="text" class="form-control error" required="">
                <label for="name" class="error">{$emp_idErr}</label>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <select id="status" name="status" class="form-control">
				   		{if isset($status)}
							...
							{else}
								{html_options options=$candidate_status selected='1'}	
							{/if}
				 		</select>
              </div>
