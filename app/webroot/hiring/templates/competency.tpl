	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Competency </span> </div>
			...
			<form action="competency.php" method="post">
			<label>
			...
			<input class="submit btn  btn-xs bg-orange2" style="color:#fff;width:auto;" type="submit" value="Go">
                  ...
                  <thead>
                    <tr>
					<th class="sorting" tabindex="0" 	title="Competency Name: activate to sort column ascending" style="width: 250px;">Competency Name</th>                     
					 <th class="sorting" tabindex="0" 	title="Status: activate to sort column ascending" style="width: 250px;">Status</th>
                  ...
                  <tbody>
                   <tr>
                      <td><a href="view_competency.php">STRESS MANAGEMENT</a></a></td>                     
                        ...
                        <td class="hidden-xs text-center">
                       	<div class="btn-group">
                        	...
                        	<ul class="dropdown-menu checkbox-persist pull-right text-left" role="menu">
                          	<li><a href="edit_competency.php"><i class="fa fa-pencil"></i> Edit </a></li>
