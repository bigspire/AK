...
$query = "CALL get_test_parameter('".$id."')";
try{
	// calling mysql exe_query function
	if(!$result = $mysql->execute_query($query)){
		throw new Exception('Problem in executing get test parameter');
	}
	while($row = $mysql->display_result($result))
	{
 		$parameters[$row['id']] = $row['parameter'];
	}
...
// display smarty file
$smarty->display('set_question_parameter.tpl');
?>