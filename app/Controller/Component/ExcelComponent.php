...
class ExcelComponent extends Component {
	...
	function _rows($template, $file) { 
		...
		$this->sheet->setCellValueByColumnAndRow(0, 1, $file);
			...
			//}
		}else if($template == 'group_report_template'){ 
			$i = 4;
			foreach($this->data as $key => $value) {
				if(!empty($this->data2[$value['Home']['id']][0])){
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$value['Home']['emp_code']);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,ucfirst(strtolower($value['Home']['first_name'])).' '.ucfirst(strtolower($value['Home']['last_name'])));
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][0]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][1]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][2]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][3]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][4]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][5]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][6]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][7]);	
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$this->data2[$value['Home']['id']][8]);
				$avg = $this->data2[$value['Home']['id']][0] + $this->data2[$value['Home']['id']][1] + $this->data2[$value['Home']['id']][2] + $this->data2[$value['Home']['id']][3] + $this->data2[$value['Home']['id']][4] + $this->data2[$value['Home']['id']][5] +$this->data2[$value['Home']['id']][6] + $this->data2[$value['Home']['id']][7] + $this->data2[$value['Home']['id']][8];
				$avg = number_format(($avg/9), 2);
				
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$avg);
				
				$this->sheet->setCellValueByColumnAndRow($j++,$i,'=AVERAGE(L4:L3340)');
				
				// echo '=IF(L'.$j.'>M'.$j.', "Yes", "No")';
				
				$this->sheet->setCellValueByColumnAndRow($j++,$i,'=IF(L'.$i.'>=M'.$i.', "Yes", "No")');

				
				// $workSheet->setCellValue('F18', '=IF(L4>M4,"Yes","NoFALSE")'); // TRUE

	
				// $this->sheet->setCellValueByColumnAndRow($j++,$i,$avg > 60 ? 'Yes' : 'No');
				
				$avg_values[] = $this->data2[$value['Home']['id']][0];
				$avg_values[] = $this->data2[$value['Home']['id']][1];
				$avg_values[] = $this->data2[$value['Home']['id']][2];
				$avg_values[] = $this->data2[$value['Home']['id']][3];
				$avg_values[] = $this->data2[$value['Home']['id']][4];
				$avg_values[] = $this->data2[$value['Home']['id']][5];
				$avg_values[] = $this->data2[$value['Home']['id']][6];
				$avg_values[] = $this->data2[$value['Home']['id']][7];
				$avg_values[] = $this->data2[$value['Home']['id']][8];
				
				$range = $this->get_number_range($avg_values);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$range[0]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$range[1]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$range[2]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$range[3]);
				$this->sheet->setCellValueByColumnAndRow($j++,$i,$range[4]);
				unset($range);
				unset($avg_values);
				$i++;				
				$j= 0;
	...
	/* function to get number range */
	public function get_number_range($avg_list){ 
		foreach($avg_list as $t){ 
			if($t > 90){
				$comp1 += 1; 
			}else if($t >= 75 && $t <= 90){
				$comp2 += 1; 
		...
		$comp_ar[] = $comp1 ? $comp1 : 0;
		$comp_ar[] = $comp2 ? $comp2 : 0;
		$comp_ar[] = $comp3 ? $comp3 : 0;
		$comp_ar[] = $comp4 ? $comp4 : 0;
		$comp_ar[] = $comp5 ? $comp5 : 0;
