 ...
 */
	...
	Configure::write('SMS_USER', 'ceotalent');
	Configure::write('SMS_PASS', 'ceotalent@567');
	Configure::write('SMS_SENDER', 'JOBFAC');
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfI4xs2guV5UubWwvdiR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453672496749683645');
